...
<CodePlayground
  template="vanilla-ts"
  files={{
    'index.html': 'files/responsive-game-screen/index.html',
    'index.ts': 'files/responsive-game-screen/index.ts'
  }}
  op
/>
...
template="vanilla-ts"
  files={{
    'index.html': 'files/drag-to-move/index.html',
    'index.ts': 'files/drag-to-move/index.ts'
  }}
/>
...
<CodePlayground
  template="vanilla-ts"
  files={{
    'index.html': 'files/block-placement/index.html',
    'index.ts': 'files/block-placement/index.ts'
  }}
/>
